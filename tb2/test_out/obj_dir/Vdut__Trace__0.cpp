...
void Vdut___024root__trace_chg_sub_0(Vdut___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgIData(oldp+66,(vlSelf->x0),32);
    bufp->chgIData(oldp+67,(vlSelf->t0),32);
    bufp->chgIData(oldp+68,(vlSelf->t1),32);
    bufp->chgIData(oldp+69,(vlSelf->t3),32);
    bufp->chgIData(oldp+70,(vlSelf->t4),32);
    bufp->chgIData(oldp+71,(vlSelf->a1),32);
    bufp->chgIData(oldp+72,(vlSelf->a2),32);
    bufp->chgIData(oldp+73,(vlSelf->a3),32);
    bufp->chgIData(oldp+74,(vlSelf->a4),32);
    bufp->chgIData(oldp+75,(vlSelf->a5),32);
    bufp->chgIData(oldp+76,(vlSelf->a6),32);
