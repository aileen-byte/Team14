...
VL_ATTR_COLD void Vdut___024root__trace_init_sub__TOP__0(Vdut___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+67,"t0", false,-1, 31,0);
    tracep->declBus(c+68,"t1", false,-1, 31,0);
    tracep->declBus(c+69,"t3", false,-1, 31,0);
    tracep->declBus(c+70,"t4", false,-1, 31,0);
    tracep->declBus(c+71,"a1", false,-1, 31,0);
    tracep->declBus(c+72,"a2", false,-1, 31,0);
    tracep->declBus(c+73,"a3", false,-1, 31,0);
    tracep->declBus(c+74,"a4", false,-1, 31,0);
    tracep->declBus(c+75,"a5", false,-1, 31,0);
    tracep->declBus(c+76,"a6", false,-1, 31,0);
    ...
    tracep->declBus(c+10,"ImmSrc", false,-1, 2,0);
    tracep->declBit(c+7,"RegWrite", false,-1);
    tracep->declBus(c+79,"ALU_ADD", false,-1, 2,0);
    tracep->declBus(c+80,"ALU_SUB", false,-1, 2,0);
    tracep->declBus(c+81,"ALU_ORI", false,-1, 2,0);
    tracep->declBus(c+79,"I_TYPE", false,-1, 2,0);
    tracep->declBus(c+80,"S_TYPE", false,-1, 2,0);
    tracep->declBus(c+82,"B_TYPE", false,-1, 2,0);
    tracep->declBus(c+83,"J_TYPE", false,-1, 2,0);
    tracep->declBus(c+84,"U_TYPE", false,-1, 2,0);
    tracep->declBus(c+85,"ALU", false,-1, 1,0);
    tracep->declBus(c+86,"Memory", false,-1, 1,0);
    tracep->declBus(c+87,"PCPlus4", false,-1, 1,0);
    tracep->declBus(c+88,"UpperImmediate", false,-1, 1,0);
    tracep->declBus(c+85,"Normal", false,-1, 1,0);
    tracep->declBus(c+86,"Immediate", false,-1, 1,0);
    tracep->declBus(c+87,"JALR", false,-1, 1,0);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("DM ");
    tracep->declBus(c+78,"DATA_WIDTH", false,-1, 31,0);
    tracep->declBus(c+89,"MEMORY_WIDTH", false,-1, 31,0);
    tracep->declBit(c+64,"clk", false,-1);
    ...
    tracep->declBus(c+91,"in3", false,-1, 31,0);
...
VL_ATTR_COLD void Vdut___024root__trace_full_sub_0(Vdut___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+67,(vlSelf->t0),32);
    bufp->fullIData(oldp+68,(vlSelf->t1),32);
    bufp->fullIData(oldp+69,(vlSelf->t3),32);
    bufp->fullIData(oldp+70,(vlSelf->t4),32);
    bufp->fullIData(oldp+71,(vlSelf->a1),32);
    bufp->fullIData(oldp+72,(vlSelf->a2),32);
    bufp->fullIData(oldp+73,(vlSelf->a3),32);
    bufp->fullIData(oldp+74,(vlSelf->a4),32);
    bufp->fullIData(oldp+75,(vlSelf->a5),32);
    bufp->fullIData(oldp+76,(vlSelf->a6),32);
    bufp->fullIData(oldp+77,(vlSelf->a0),32);
    bufp->fullIData(oldp+78,(0x20U),32);
    bufp->fullCData(oldp+79,(0U),3);
    bufp->fullCData(oldp+80,(1U),3);
    bufp->fullCData(oldp+81,(6U),3);
    bufp->fullCData(oldp+82,(2U),3);
    bufp->fullCData(oldp+83,(3U),3);
    bufp->fullCData(oldp+84,(4U),3);
    bufp->fullCData(oldp+85,(0U),2);
    bufp->fullCData(oldp+86,(1U),2);
    bufp->fullCData(oldp+87,(2U),2);
    bufp->fullCData(oldp+88,(3U),2);
    bufp->fullIData(oldp+89,(0x20000U),32);
    bufp->fullIData(oldp+90,(0x3e8U),32);
