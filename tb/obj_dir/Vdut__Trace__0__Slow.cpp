...
VL_ATTR_COLD void Vdut___024root__trace_init_sub__TOP__0(Vdut___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+68,"x0", false,-1, 31,0);
    tracep->declBus(c+69,"t0", false,-1, 31,0);
    tracep->declBus(c+70,"t1", false,-1, 31,0);
    tracep->declBus(c+71,"t3", false,-1, 31,0);
    tracep->declBus(c+72,"t4", false,-1, 31,0);
    tracep->declBus(c+73,"a1", false,-1, 31,0);
    tracep->declBus(c+74,"a2", false,-1, 31,0);
    tracep->declBus(c+75,"a3", false,-1, 31,0);
    tracep->declBus(c+76,"a4", false,-1, 31,0);
    tracep->declBus(c+77,"a5", false,-1, 31,0);
    tracep->declBus(c+78,"a6", false,-1, 31,0);
    ...
    tracep->declBus(c+10,"ImmSrc", false,-1, 2,0);
    tracep->declBit(c+7,"RegWrite", false,-1);
    tracep->declBus(c+81,"ALU_ADD", false,-1, 2,0);
    tracep->declBus(c+82,"ALU_SUB", false,-1, 2,0);
    tracep->declBus(c+83,"ALU_XOR", false,-1, 2,0);
    tracep->declBus(c+81,"I_TYPE", false,-1, 2,0);
    tracep->declBus(c+82,"S_TYPE", false,-1, 2,0);
    tracep->declBus(c+84,"B_TYPE", false,-1, 2,0);
    tracep->declBus(c+83,"J_TYPE", false,-1, 2,0);
    ...
    tracep->declBus(c+27,"word_base", false,-1, 31,0);
    tracep->popNamePrefix(1);
    ...
    tracep->declBus(c+80,"DATA_WIDTH", false,-1, 31,0);
    tracep->declBus(c+25,"funct3", false,-1, 2,0);
    tracep->declBus(c+28,"byte_num", false,-1, 1,0);
    ...
    tracep->declBus(c+80,"DATA_WIDTH", false,-1, 31,0);
    tracep->declBit(c+65,"clk", false,-1);
    tracep->declBus(c+29,"AD1", false,-1, 4,0);
    tracep->declBus(c+30,"AD2", false,-1, 4,0);
    ...
    tracep->declBus(c+64,"instr", false,-1, 31,7);
    tracep->declBus(c+10,"ImmSrc", false,-1, 2,0);
    tracep->declBus(c+22,"ImmOp", false,-1, 31,0);
    tracep->popNamePrefix(1);
...
VL_ATTR_COLD void Vdut___024root__trace_full_sub_0(Vdut___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+26,((1U & (vlSelf->top__DOT__instr 
                                  >> 0x1eU))));
    bufp->fullIData(oldp+27,((0xfffffffcU & vlSelf->top__DOT__ALUout)),32);
    bufp->fullCData(oldp+28,((3U & vlSelf->top__DOT__ALUout)),2);
    ...
    bufp->fullCData(oldp+31,((0x1fU & (vlSelf->top__DOT__instr 
                                       >> 7U))),5);
    bufp->fullIData(oldp+32,(vlSelf->top__DOT__RF__DOT__regs[0]),32);
    bufp->fullIData(oldp+33,(vlSelf->top__DOT__RF__DOT__regs[1]),32);
    bufp->fullIData(oldp+34,(vlSelf->top__DOT__RF__DOT__regs[2]),32);
    bufp->fullIData(oldp+35,(vlSelf->top__DOT__RF__DOT__regs[3]),32);
    bufp->fullIData(oldp+36,(vlSelf->top__DOT__RF__DOT__regs[4]),32);
    bufp->fullIData(oldp+37,(vlSelf->top__DOT__RF__DOT__regs[5]),32);
    bufp->fullIData(oldp+38,(vlSelf->top__DOT__RF__DOT__regs[6]),32);
    bufp->fullIData(oldp+39,(vlSelf->top__DOT__RF__DOT__regs[7]),32);
    bufp->fullIData(oldp+40,(vlSelf->top__DOT__RF__DOT__regs[8]),32);
    bufp->fullIData(oldp+41,(vlSelf->top__DOT__RF__DOT__regs[9]),32);
    bufp->fullIData(oldp+42,(vlSelf->top__DOT__RF__DOT__regs[10]),32);
    bufp->fullIData(oldp+43,(vlSelf->top__DOT__RF__DOT__regs[11]),32);
    bufp->fullIData(oldp+44,(vlSelf->top__DOT__RF__DOT__regs[12]),32);
    bufp->fullIData(oldp+45,(vlSelf->top__DOT__RF__DOT__regs[13]),32);
    bufp->fullIData(oldp+46,(vlSelf->top__DOT__RF__DOT__regs[14]),32);
    bufp->fullIData(oldp+47,(vlSelf->top__DOT__RF__DOT__regs[15]),32);
    bufp->fullIData(oldp+48,(vlSelf->top__DOT__RF__DOT__regs[16]),32);
    bufp->fullIData(oldp+49,(vlSelf->top__DOT__RF__DOT__regs[17]),32);
    bufp->fullIData(oldp+50,(vlSelf->top__DOT__RF__DOT__regs[18]),32);
    bufp->fullIData(oldp+51,(vlSelf->top__DOT__RF__DOT__regs[19]),32);
    bufp->fullIData(oldp+52,(vlSelf->top__DOT__RF__DOT__regs[20]),32);
    bufp->fullIData(oldp+53,(vlSelf->top__DOT__RF__DOT__regs[21]),32);
    bufp->fullIData(oldp+54,(vlSelf->top__DOT__RF__DOT__regs[22]),32);
    bufp->fullIData(oldp+55,(vlSelf->top__DOT__RF__DOT__regs[23]),32);
    bufp->fullIData(oldp+56,(vlSelf->top__DOT__RF__DOT__regs[24]),32);
    bufp->fullIData(oldp+57,(vlSelf->top__DOT__RF__DOT__regs[25]),32);
    bufp->fullIData(oldp+58,(vlSelf->top__DOT__RF__DOT__regs[26]),32);
    bufp->fullIData(oldp+59,(vlSelf->top__DOT__RF__DOT__regs[27]),32);
    bufp->fullIData(oldp+60,(vlSelf->top__DOT__RF__DOT__regs[28]),32);
    bufp->fullIData(oldp+61,(vlSelf->top__DOT__RF__DOT__regs[29]),32);
    bufp->fullIData(oldp+62,(vlSelf->top__DOT__RF__DOT__regs[30]),32);
    bufp->fullIData(oldp+63,(vlSelf->top__DOT__RF__DOT__regs[31]),32);
    bufp->fullIData(oldp+64,((vlSelf->top__DOT__instr 
                              >> 7U)),25);
    bufp->fullBit(oldp+65,(vlSelf->clk));
    bufp->fullBit(oldp+66,(vlSelf->rst));
    bufp->fullBit(oldp+67,(vlSelf->trigger));
    bufp->fullIData(oldp+68,(vlSelf->x0),32);
    bufp->fullIData(oldp+69,(vlSelf->t0),32);
    bufp->fullIData(oldp+70,(vlSelf->t1),32);
    bufp->fullIData(oldp+71,(vlSelf->t3),32);
    bufp->fullIData(oldp+72,(vlSelf->t4),32);
    bufp->fullIData(oldp+73,(vlSelf->a1),32);
    bufp->fullIData(oldp+74,(vlSelf->a2),32);
    bufp->fullIData(oldp+75,(vlSelf->a3),32);
    bufp->fullIData(oldp+76,(vlSelf->a4),32);
    bufp->fullIData(oldp+77,(vlSelf->a5),32);
    bufp->fullIData(oldp+78,(vlSelf->a6),32);
