...
VL_ATTR_COLD void Vdut___024root___initial__TOP__0(Vdut___024root* vlSelf) {
    ...
    // Init
    VlWide<5>/*159:0*/ __Vtemp_h7c4fed6e__0;
    // Body
    vlSelf->a0 = 5U;
    __Vtemp_h7c4fed6e__0[0U] = 0x2e686578U;
    __Vtemp_h7c4fed6e__0[1U] = 0x72616d31U;
    __Vtemp_h7c4fed6e__0[2U] = 0x70726f67U;
    __Vtemp_h7c4fed6e__0[3U] = 0x72746c2fU;
    __Vtemp_h7c4fed6e__0[4U] = 0x2e2e2fU;
    VL_READMEM_N(true, 32, 101, 0, VL_CVT_PACK_STR_NW(5, __Vtemp_h7c4fed6e__0)
...
VL_ATTR_COLD void Vdut___024root___settle__TOP__0(Vdut___024root* vlSelf) {
    ...
    vlSelf->instr = ((0x64U >= (0x7fU & (vlSelf->top__DOT__pc 
                                         >> 2U))) ? 
                     vlSelf->top__DOT__IMEM__DOT__memory
    ...
    if (((((((((0x33U == (0x7fU & vlSelf->instr)) | 
             ...
             (0x13U == (0x7fU & vlSelf->instr))) | 
            (0x37U == (0x7fU & vlSelf->instr))) | (0x23U 
                                                   == 
                                                   (0x7fU 
                                                    & vlSelf->instr))) 
          | (0x63U == (0x7fU & vlSelf->instr))) | (0x6fU 
                                                   == 
                                                   (0x7fU 
                                                    & vlSelf->instr)))) {
        if ((0x33U == (0x7fU & vlSelf->instr))) {
            ...
            if ((0x67U == (0x7fU & vlSelf->instr))) {
                ...
                if ((0x37U != (0x7fU & vlSelf->instr))) {
                    if ((0x23U == (0x7fU & vlSelf->instr))) {
                        vlSelf->top__DOT__ALUctrl = 0U;
                        vlSelf->top__DOT__ALUSrc = 1U;
                    } else if ((0x63U == (0x7fU & vlSelf->instr))) {
                        if ((1U == (7U & (vlSelf->instr 
                                          >> 0xcU)))) {
...
VL_ATTR_COLD void Vdut___024root___ctor_var_reset(Vdut___024root* vlSelf) {
    ...
    for (int __Vi0=0; __Vi0<2; ++__Vi0) {
        vlSelf->top__DOT__DM__DOT__mem_array[__Vi0] = VL_RAND_RESET_I(32);
    }
    for (int __Vi0=0; __Vi0<2; ++__Vi0) {
